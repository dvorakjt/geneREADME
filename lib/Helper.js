            ...
            switch (choice) {
                case 0: {
                    console.log(purple("GeneREADME") + " takes user input through the console and generates a README.md file. " +
                        ...
                        "are designed to work using your GitHub username and repo name. At the end of the process, you will be able to " +
                        "specify a directory to write the README file to. This allows you to save it directly in your local repo folder.");
                    break;
                }
                case 1: {
