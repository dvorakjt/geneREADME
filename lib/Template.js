...
class Template {
    constructor({ title, mainImgUrl, quickDescription, deployed, userName, repoName, introText, installImgUrl, installTxt, useImgUrl, usageTxt, testTxt, contribTxt, licenseName, yourName, githubProfPicUrl, dependenciesTxt }) {
        this.name = repoName;
        this.text =
            `# ${title}
...
${contribTxt} README generated by GeneREADME. Original template written with [StackEdit](https://stackedit.io/). Badges provided through shields.io.
...
## About the Author
![Github Proflie Picture](${githubProfPicUrl})
${yourName}
Github: ${userName}
